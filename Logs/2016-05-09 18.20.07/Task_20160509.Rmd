...
sessionPath <- "Sessions/2016-05-09 18.20.07/"
...
NOCNOm <- mean(results$ErrorFraction[(results$AnimalName == "Animal 13" | results$AnimalName == "Animal 6" | results$AnimalName == "Animal 9") & (results$ModuleName == "Module 1" | results$ModuleName == "Module 2" | results$ModuleName == "Module 3")])
NOCNOsd <- sd(results$ErrorFraction[(results$AnimalName == "Animal 13" | results$AnimalName == "Animal 6" | results$AnimalName == "Animal 9") & (results$ModuleName == "Module 1" | results$ModuleName == "Module 2" | results$ModuleName == "Module 3")])


CNOm <- mean(results$ErrorFraction[(results$AnimalName == "Animal 2" | results$AnimalName == "Animal 4" | results$AnimalName == "Animal 5") & (results$ModuleName == "Module 1" | results$ModuleName == "Module 2" | results$ModuleName == "Module 3")])
CNOsd <- sd(results$ErrorFraction[(results$AnimalName == "Animal 2" | results$AnimalName == "Animal 4" | results$AnimalName == "Animal 5") & (results$ModuleName == "Module 1" | results$ModuleName == "Module 2" | results$ModuleName == "Module 3")])

SOUNDNOCNOm <- mean(results$ErrorFraction[(results$AnimalName == "Animal 13" | results$AnimalName == "Animal 6" | results$AnimalName == "Animal 9") & (results$ModuleName == "Module 4" | results$ModuleName == "Module 5" | results$ModuleName == "Module 6")]) 

SOUNDNOCNOsd <- sd(results$ErrorFraction[(results$AnimalName == "Animal 13" | results$AnimalName == "Animal 6" | results$AnimalName == "Animal 9") & (results$ModuleName == "Module 4" | results$ModuleName == "Module 5" | results$ModuleName == "Module 6")]) 

SOUNDCNOm <- mean(results$ErrorFraction[(results$AnimalName == "Animal 2" | results$AnimalName == "Animal 4" | results$AnimalName == "Animal 5") & (results$ModuleName == "Module 4" | results$ModuleName == "Module 5" | results$ModuleName == "Module 6")]) 

SOUNDCNOsd <- sd(results$ErrorFraction[(results$AnimalName == "Animal 2" | results$AnimalName == "Animal 4" | results$AnimalName == "Animal 5") & (results$ModuleName == "Module 4" | results$ModuleName == "Module 5" | results$ModuleName == "Module 6")])

m <- c(NOCNOm, CNOm, SOUNDNOCNOm, SOUNDCNOm)
s <- c(NOCNOsd, CNOsd, SOUNDNOCNOsd, SOUNDCNOsd)
cond <- c("NO CNO", "CNO", "SOUND", "SOUND CNO" )
mydf <- data.frame(m,s,cond)

dodge <- position_dodge(width = 0.9)
limits <- aes(ymax = mydf$m + mydf$s,
               ymin = mydf$m - mydf$s)
p6 <- ggplot(data = mydf, aes(x = cond, y = m, fill = cond)) +
