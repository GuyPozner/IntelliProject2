...
results$Injection[results$Day == 22 & !(results$AnimalName =="Animal 4" | results$AnimalName =="Animal 6" | results$AnimalName == "Animal 13")] <- "Saline"
results$Injection[results$Day == 23 & !(results$AnimalName =="Animal 4" | results$AnimalName =="Animal 6" | results$AnimalName == "Animal 13")] <- "CNO"
