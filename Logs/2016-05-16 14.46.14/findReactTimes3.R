findReactTimes3 <- function(visits, windowNosepokes){
        rTimes <- lapply(windowNosepokes$VisitID, 
                        ...
                        if(visits$ModuleName[visits$VisitID == x] == "Module 4"){
                                delay <- 1.5
                        }
                        if(visits$ModuleName[visits$VisitID == x] == "Module 5"){
                                delay <- 2.5
                        }
                        if(visits$ModuleName[visits$VisitID == x] == "Module 6"){
                                delay <- 3.5
                        }
