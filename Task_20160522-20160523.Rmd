...
reactionMeanGroups$Injection <- factor(as.factor(reactionMeanGroups$Injection),
                                     levels(as.factor(reactionMeanGroups$Injection))[c(2,1)])
reactionMeanGroups$Sound <- factor(as.factor(reactionMeanGroups$Sound),
                                 levels(as.factor(reactionMeanGroups$Sound))[c(1,2)])
...
#reorder factor levels to make the graph in the logical order
ImpulseErrorMean$Injection <- factor(as.factor(ImpulseErrorMean$Injection),
                                     levels(as.factor(ImpulseErrorMean$Injection))[c(2,1)])
ImpulseErrorMean$Sound <- factor(as.factor(ImpulseErrorMean$Sound),
                                 levels(as.factor(ImpulseErrorMean$Sound))[c(1,2)])
