...
sessionPath1 <- "Sessions/2016-05-10 13.20.36/"
sessionPath2 <- "Sessions/2016-05-09 18.20.07/"
...
windowNosepokes$Injection[windowNosepokes$Day == 9 & (windowNosepokes$AnimalName =="Animal 2" | windowNosepokes$AnimalName =="Animal 4" | windowNosepokes$AnimalName == "Animal 5")] <- "CNO"
windowNosepokes$Injection[windowNosepokes$Day == 9 & !(windowNosepokes$AnimalName =="Animal 2" | windowNosepokes$AnimalName =="Animal 4" | windowNosepokes$AnimalName == "Animal 5")] <- "Saline"
windowNosepokes$Injection[windowNosepokes$Day == 10 & !(windowNosepokes$AnimalName =="Animal 2" | windowNosepokes$AnimalName =="Animal 4" | windowNosepokes$AnimalName == "Animal 5")] <- "CNO"
windowNosepokes$Injection[windowNosepokes$Day == 10 & (windowNosepokes$AnimalName =="Animal 2" | windowNosepokes$AnimalName =="Animal 4" | windowNosepokes$AnimalName == "Animal 5")] <- "Saline"
...
#Add sound and injection factor columns
results$Injection[results$Day == 9 & (results$AnimalName =="Animal 2" | results$AnimalName =="Animal 4" | results$AnimalName == "Animal 5")] <- "CNO"
results$Injection[results$Day == 9 & !(results$AnimalName =="Animal 2" | results$AnimalName =="Animal 4" | results$AnimalName == "Animal 5")] <- "Saline"
results$Injection[results$Day == 10 & !(results$AnimalName =="Animal 2" | results$AnimalName =="Animal 4" | results$AnimalName == "Animal 5")] <- "CNO"
results$Injection[results$Day == 10 & (results$AnimalName =="Animal 2" | results$AnimalName =="Animal 4" | results$AnimalName == "Animal 5")] <- "Saline"
